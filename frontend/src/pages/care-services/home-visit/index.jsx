...
const hvServices = [
  ...
  ["Physiotherapy at Home", "Svasth physiotherapists deliver expert care at home to enhance mobility and improve quality of life.", Activity, "/care-services/home-visit/physiotherapy-at-home/"],
...
function HomeVisitPage() {
  return <PageShell breadcrumbs={[{ label: "Home Visit" }]}>
    ...
    <Section id="services" eyebrow="Home Visit" title="Choose the right care solution" lead="Svasth Homecare's home visit services are designed to provide professional healthcare in the comfort of your home." tone="ivory">
      <FilteredGrid items={hvItems} initialCount={3} placeholder="Select a service" />
    </Section>
    <Section eyebrow="Why Choose Svasth Homecare" title="Trusted care at home" tone="white">
