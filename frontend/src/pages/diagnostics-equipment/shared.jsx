...
const DEFAULT_STEPS = [
  ...
  { title: "Care team confirms", description: "The Apollo Homecare team coordinates availability, timing and the next steps with you." },
...
export const PAGE_DATA = {
  ...
  insuranceTPA: {
    ...
    faqs: [
      ...
      { question: "Will Apollo guarantee reimbursement?", answer: "No. Reimbursement or cashless approval is determined by the insurer or TPA according to the applicable policy and approval process." },
    ],
  },
  nebulization: {
  ...
  testimonials: {
    ...
    lead: "A place for patient and family experiences, service feedback and approved care stories across Apollo Homecare.",
    path: "/testimonials/",
...
export function PersonBPage({ data }) {
  return (
    <>
      <Head>
        <title>{data.title} | Apollo Homecare</title>
        <meta name="description" content={data.lead} />
      </Head>
      <header className="header">
        <div className="header-container">
          <a href="/" className="header-logo font-display text-xl font-semibold text-neutral-900">Apollo Homecare</a>
      ...
      <main id="main-content">
        ...
        <FinalCTASection title="Ready to get started?" lead="Tell the Apollo Homecare team what you need and we will help you with the next step." cta={data.primary} />
      </main>
