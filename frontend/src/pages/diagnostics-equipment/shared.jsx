    ...
    <header className="sticky top-0 z-50 border-b border-black/5 bg-[#faf7f1]/95 backdrop-blur">
      ...
      <div className="mx-auto flex h-[68px] max-w-7xl items-center justify-between px-4 md:px-6">
        ...
        <div className="hidden items-center gap-3 lg:flex">
          <Link href="/home-diagnostics/" className="btn btn-secondary h-10 px-4 text-sm">Book a service</Link>
...
export function Hero({ eyebrow, title, description, primary = ["Enquire Now", "/home-diagnostics/"], secondary, icon: Icon = Stethoscope }) {
